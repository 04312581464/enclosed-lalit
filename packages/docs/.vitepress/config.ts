...
export default defineConfig({
  ...
  themeConfig: {
    ...
    editLink: {
      pattern: 'https://github.com/04312581464/enclosed-lalit/edit/main/packages/docs/src/:path',
      text: 'Edit this page on GitHub',
    },

    socialLinks: [
      { icon: { svg: githubIcon }, link: 'https://github.com/04312581464/enclosed-lalit', ariaLabel: 'GitHub' },
